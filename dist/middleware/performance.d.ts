...
export declare const morganMiddleware: (req: Request<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs, Record<string, any>>, res: Response<any, Record<string, any>>, callback: (err?: Error) => void) => void;
export declare const responseTime: (_req: Request, res: Response, next: NextFunction) => void;
export declare const cache: (ttl?: number) => (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const optimizeQueries: (req: Request, _res: Response, next: NextFunction) => void;
export declare const pagination: (req: Request, _res: Response, next: NextFunction) => void;
export declare const memoryMonitor: (_req: Request, res: Response, next: NextFunction) => void;
export declare const requestTimeout: (timeout?: number) => (req: Request, res: Response, next: NextFunction) => void;
